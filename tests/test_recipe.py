...
class TestRecipe:
    ...
    def test_create_recipe(self, driver):
        ...
        # Переходим на главную страницу, где отображаются рецепты
        main_page.navigate_to(BASE_URL)
        
        # Ожидаем появления карточки рецепта на главной странице
        recipe_page.wait_for_element(recipe_page.RECIPE_CARD, timeout=20)
